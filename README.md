...
- **柔軟なマウント対応**  
  キースイッチ穴（14×14mm）への装着や、torabo-tsuki LP等へのマウントに対応しています。  
- **操作性と持ち運びやすさの両立**  
...
- **torabo-tsuki LP ボトムプレートマウント用**
👉 [データ](./19mm-case_torabotsukiLP/)
  - torabo-tsuki LPのボトムプレートへ直接マウントするタイプです。
  - torabo-tsuki LPに付属しているM2ネジ2本を使用して，ボトムプレートに固定してください。
...
> ⚠️ **注意点**  
> 各トラックボールに磁性があることは販売元公式の公称仕様ではありません。当方で入手した個体においては磁性があり、本ケースで問題なく保持・操作できることを確認済みですが、ロットや仕様変更等により動作が異なる可能性がある点をご了承ください。
